...
const s = StyleSheet.create({
  ...
  playAll: { borderWidth: 1, borderColor: colors.primary, paddingHorizontal: spacing.md, paddingVertical: spacing.sm },
  playAllText: { fontFamily: fonts.mono, fontSize: 12, color: colors.primary, letterSpacing: 1 },
  shuffleBtn: { borderWidth: 1, borderColor: colors.primary, padding: spacing.sm, alignItems: 'center', justifyContent: 'center' },
